//
//  HSQUserAndMobileLoginViewController.m
//  LiTianDecoration
//
...
#import "HSQUserAccountLoginViewController.h"  // 用户账号登录
#import "HSQMobileLoginViewController.h"  // 手机动态码登录

@interface HSQUserAndMobileLoginViewController ()<UIScrollViewDelegate>
...
@implementation HSQUserAndMobileLoginViewController
...
- (void)setupChildVces{
    ...
    UserAccountLoginVC.title = @"用户登录";
    [self addChildViewController:UserAccountLoginVC];
    
    // 2.手机动态码登录
    HSQMobileLoginViewController *MobileLoginVC = [[HSQMobileLoginViewController alloc] init];
    MobileLoginVC.title = @"手机动态码登录";
    [self addChildViewController:MobileLoginVC];
...
- (void)setupContentView{
    ...
    contentView.frame = CGRectMake(0, ScrollerHeight, KScreenWidth, KScreenHeight - ScrollerHeight - KSafeTopeHeight - KSafeBottomHeight - 150);
