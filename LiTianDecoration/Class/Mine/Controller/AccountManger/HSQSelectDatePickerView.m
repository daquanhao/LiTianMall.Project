...
#import "HSQSelectDatePickerView.h"
...
@interface HSQSelectDatePickerView()<UIPickerViewDataSource, UIPickerViewDelegate>
{
    NSInteger yearRange;
    NSInteger dayRange;
    NSInteger startYear;
...
@implementation HSQSelectDatePickerView
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        UIView *contentV = [[UIView alloc] initWithFrame:CGRectMake(0, screenHeight, screenWith, screenHeight * 0.4)];
        contentV.backgroundColor = [UIColor whiteColor];
        [self addSubview:contentV];
        self.contentV = contentV;
        
        self.pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, 20, screenWith, screenHeight * 0.4 - 40)];
        ...
        [cancelButton setTitleColor:RGB(0, 187, 211) forState:(UIControlStateNormal)];
        ...
        [chooseButton setTitleColor:RGB(0, 187, 211) forState:(UIControlStateNormal)];
...
- (void)pickerView:(UIPickerView *)pickerView
    ...
    if (self.pickerViewMode == DatePickerViewDateTimeMode) {
        ...
        _string =[NSString stringWithFormat:@"%.2ld:%.2ld",(long)selectedHour,(long)selectedMinute];
    }
...
- (void)showHSQSelectDatePickerView{
    ...
    [UIView animateWithDuration:0.25f animations:^{
        self.alpha = 1;
        self.contentV.frame = CGRectMake(0, screenHeight * 0.6, screenWith, screenHeight * 0.4);
...
- (void)hideHSQSelectDatePickerView{
    ...
    [UIView animateWithDuration:0.2f animations:^{
        self.alpha = 0;
        self.contentV.frame = CGRectMake(0, screenHeight, screenWith, screenHeight*0.4);
    } completion:^(BOOL finished) {
...
{
    if (self.delegate != nil && [self.delegate respondsToSelector:@selector(didClickCancelHSQSelectDatePickerView)]) {
        [self.delegate didClickCancelHSQSelectDatePickerView];
    }
    
    [self hideHSQSelectDatePickerView];
...
-(void)configButtonClick
{
    ...
    if (self.delegate != nil && [self.delegate respondsToSelector:@selector(didClickFinishHSQSelectDatePickerView:)]) {
        
        [self.delegate didClickFinishHSQSelectDatePickerView:_string];
    }
