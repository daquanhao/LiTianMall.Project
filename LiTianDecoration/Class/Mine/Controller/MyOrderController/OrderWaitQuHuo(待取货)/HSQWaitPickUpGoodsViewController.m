//
//  HSQWaitPickUpGoodsViewController.m
//  LiTianDecoration
//
...
#import "HSQWaitPickUpGoodsViewController.h"
...
@interface HSQWaitPickUpGoodsViewController ()<UITableViewDelegate,UITableViewDataSource,HSQOrderGoodsListCellDelegate>
...
@implementation HSQWaitPickUpGoodsViewController
...
- (void)OrderCancelBtnClickAction:(UIButton *)sender{
    ...
    UIAlertAction *delete_action = [UIAlertAction actionWithTitle:@"确认" style:(UIAlertActionStyleDefault) handler:^(UIAlertAction * _Nonnull action) {
        ...
        [self NotifServerQRShouHuoWithModelIndex:indexPath];
    }];
 ...
 * @brief 通知服务器，确认收货
 */
- (void)NotifServerQRShouHuoWithModelIndex:(NSIndexPath *)indexPath{
