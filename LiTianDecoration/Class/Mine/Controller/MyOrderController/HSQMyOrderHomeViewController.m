...
#import "HSQMyOrderListViewController.h"
...
- (void)setupChildVces{
    ...
    // 1.待接单
    HSQMyOrderListViewController *WaitOrderVC = [[HSQMyOrderListViewController alloc] init];
    WaitOrderVC.title = @"全部";
    [self addChildViewController:WaitOrderVC];
    
    // 2.进行中
    HSQMyOrderListViewController *OningOrderVC = [[HSQMyOrderListViewController alloc] init];
    OningOrderVC.title = @"待付款";
    [self addChildViewController:OningOrderVC];
    
    // 3.待送达
    HSQMyOrderListViewController *WaitSendOrderVC = [[HSQMyOrderListViewController alloc] init];
    WaitSendOrderVC.title = @"待发货";
    [self addChildViewController:WaitSendOrderVC];
    
    // 4.待收/取货
    HSQMyOrderListViewController *ClosedGoodsVC = [[HSQMyOrderListViewController alloc] init];
    ClosedGoodsVC.title = @"待收/取货";
    [self addChildViewController:ClosedGoodsVC];
    
    // 3.待评价
    HSQMyOrderListViewController *ToEvaluateVC = [[HSQMyOrderListViewController alloc] init];
