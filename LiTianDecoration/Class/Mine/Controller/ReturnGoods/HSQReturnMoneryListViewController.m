//
//  HSQReturnMoneryListViewController.m
//  LiTianDecoration
//
...
#import "HSQReturnMoneryListViewController.h"
...
@interface HSQReturnMoneryListViewController ()<UITableViewDataSource,UITableViewDelegate,HSQTuiMoneryListFooterViewDelegate>
...
@implementation HSQReturnMoneryListViewController
...
- (void)LoadNewTouSuOrderListData{
    ...
    [requestTool.manger POST:UrlAdress(KTuiMoneryListUrl) parameters:params progress:^(NSProgress * _Nonnull uploadProgress) {
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    FooterView.CountBgView.hidden = YES;
