...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        goodName_Label.text = @"MacBook Pro 13.3英寸苹果笔记本电脑（I5  2.7GHz  8G  128G）";
        ...
        KaiTuanCount_Label.font = [UIFont systemFontOfSize:KTextFont_(12)];
        KaiTuanCount_Label.text = @"已团999件";
        ...
        KaiTuan_Button.titleLabel.font = [UIFont systemFontOfSize:KTextFont_(12)];
        ...
        PrePrice_Label.font = [UIFont systemFontOfSize:KTextFont_(14)];
        PrePrice_Label.text = @"¥ 6399.00";
        ...
        OriginalPrice_Label.font = [UIFont systemFontOfSize:KTextFont_(14)];
        OriginalPrice_Label.text = @"¥ 6399.00";
...
- (void)AddViewLayOut{
    ...
    // 开团的人数
    self.KaiTuanCount_Label.sd_layout.leftEqualToView(self.GoodsName_Label).topSpaceToView(self.GoodsName_Label, 10).rightSpaceToView(self.contentView, 10).heightIs(20);
    
    // 去开团的按钮
    self.KaiTuan_Button.sd_layout.rightSpaceToView(self.contentView, 15).topSpaceToView(self.KaiTuanCount_Label, 10).widthIs(70).heightIs(25);
