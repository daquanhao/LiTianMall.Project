//
//  HSQGoodsDetailHeadBannerCell.m
//  LiTianDecoration
//
...
@interface HSQGoodsDetailHeadBannerCell ()<SDCycleScrollViewDelegate>
...
@implementation HSQGoodsDetailHeadBannerCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        countLabel.backgroundColor = RGB(204, 204, 204);
