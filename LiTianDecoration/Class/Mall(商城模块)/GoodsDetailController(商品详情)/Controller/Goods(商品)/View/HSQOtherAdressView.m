...
@interface HSQOtherAdressView ()<UIScrollViewDelegate,UITableViewDelegate,UITableViewDataSource>
...
@property (nonatomic, strong) NSMutableArray *dataSource; // 省级别数据源

@end

@implementation HSQOtherAdressView
...
- (void)SetUpViews{
    ...
    // 4.提示文字下面的地址视图
    HSQAddressView *TopBarView = [[HSQAddressView alloc] initWithFrame:CGRectMake(0, 0, KScreenWidth, KPlacherLabelHeight)];
    ...
    // 5.底部的滚动式图
    CGFloat contentViewH = self.mj_h - KPlacherLabelHeight - KSafeBottomHeight;
    UIScrollView * contentView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(self.TopBarView.frame), self.mj_w, contentViewH)];
