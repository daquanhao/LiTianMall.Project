...
- (instancetype)initWithTitle:(NSString *)scrollTitle  type:(TXScrollLabelViewType)scrollType velocity:(NSTimeInterval)scrollVelocity options:(UIViewAnimationOptions)options inset:(UIEdgeInsets)inset;

#pragma mark - Factory Methods

+ (instancetype)scrollWithTitle:(NSString *)scrollTitle;

+ (instancetype)scrollWithTitle:(NSString *)scrollTitle  type:(TXScrollLabelViewType)scrollType;

+ (instancetype)scrollWithTitle:(NSString *)scrollTitle type:(TXScrollLabelViewType)scrollType velocity:(NSTimeInterval)scrollVelocity;

+ (instancetype)scrollWithTitle:(NSString *)scrollTitle type:(TXScrollLabelViewType)scrollType velocity:(NSTimeInterval)scrollVelocity options:(UIViewAnimationOptions)options;
 ...
 */
+ (instancetype)scrollWithTitle:(NSString *)scrollTitle type:(TXScrollLabelViewType)scrollType velocity:(NSTimeInterval)scrollVelocity options:(UIViewAnimationOptions)options inset:(UIEdgeInsets)inset;
 ...
 */
- (instancetype)initWithTextArray:(NSArray *)scrollTexts   type:(TXScrollLabelViewType)scrollType velocity:(NSTimeInterval)scrollVelocity options:(UIViewAnimationOptions)options inset:(UIEdgeInsets)inset;

+ (instancetype)scrollWithTextArray:(NSArray *)scrollTexts  type:(TXScrollLabelViewType)scrollType velocity:(NSTimeInterval)scrollVelocity  options:(UIViewAnimationOptions)options  inset:(UIEdgeInsets)inset;
...
+ (instancetype)tx_setScrollTitle:(NSString *)scrollTitle scrollType:(TXScrollLabelViewType)scrollType TX_DEPRECATED_MESSAGES("Method deprecated. Use `+ scrollWithTitle:type:`");

+ (instancetype)tx_setScrollTitle:(NSString *)scrollTitle scrollType:(TXScrollLabelViewType)scrollType scrollVelocity:(NSTimeInterval)scrollVelocity TX_DEPRECATED_MESSAGES("Method deprecated. Use `+ scrollWithTitle:type:velocity:`");

+ (instancetype)tx_setScrollTitle:(NSString *)scrollTitle scrollType:(TXScrollLabelViewType)scrollType scrollVelocity:(NSTimeInterval)scrollVelocity options:(UIViewAnimationOptions)options TX_DEPRECATED_MESSAGES("Method deprecated. Use `+ scrollWithTitle:type:velocity:options:`");

+ (instancetype)tx_setScrollTitle:(NSString *)scrollTitle scrollType:(TXScrollLabelViewType)scrollType  scrollVelocity:(NSTimeInterval)scrollVelocity options:(UIViewAnimationOptions)options inset:(UIEdgeInsets)inset TX_DEPRECATED_MESSAGES("Method deprecated. Use `+ scrollWithTitle:type:velocity:options:inset:`");
@end
